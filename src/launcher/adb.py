...
ARCH_TO_FRIDA_SERVER_XZ_FILEPATH = {
    "arm64-v8a": "frida-server/frida-server-17.2.4-android-arm64.xz",
    "x86_64": "frida-server/frida-server-17.2.4-android-x86_64.xz",
}

ANDROID_FRIDA_SERVER_FILEPATH = "/data/local/tmp/florida-17.2.4"
