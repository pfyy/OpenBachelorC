...
ARCH_TO_FRIDA_SERVER_XZ_FILEPATH = {
    "arm64-v8a": "frida-server/frida-server-16.7.13-android-arm64.xz",
    "x86_64": "frida-server/frida-server-16.7.13-android-x86_64.xz",
}

ANDROID_FRIDA_SERVER_FILEPATH = "/data/local/tmp/florida-16.7.13"
